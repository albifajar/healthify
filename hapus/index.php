...
<body>
    ...
    <div class="container-caredoc" id="healthify">
        <div class="content-caredoc">
            <div class="title-caredoc">
                <h4 class="text-capitalize font-weight-bold" style="color: white">Artikel Terbaru</h4>
            </div>
            <div class="artikel-box">
                <div class="artikel-box-b1">
                    <div class="box" id="box-1">
                        <img src="assets/img/content/artikel/artikel-1.png" alt="" />
                        <p class="box-judul">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        </p>
                        <p class="box-isi">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Nulla sed enim laoreet, sodales tortor vestibulum,
                            consectetur quam.
                        </p>
                    </div>
                    <div class="box" id="box-3">
                        <img src="assets/img/content/artikel/artikel-2.png" alt="" />
                        <p class="box-judul">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        </p>
                        <p class="box-isi">
                    ...
                    <div class="box" id="box-3">
                        <img src="assets/img/content/artikel/artikel-3.png" alt="" />
                        <p class="box-judul">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        </p>
                        <p class="box-isi">
